...
const Detail = ({ measures, orderService, componentDataSource,orderServiceAttachment, form, type, onSubmit, moreProps, dispatch, ...rest }) => {
    const {uploadAttachmentAble} = rest;
                            ...
                            <Row>
                                ...
                                <Col span="12">
                                    <FormItem
                                        ...
                                        >
                                        <DatePicker {...needTimeProps} disabled={measures.submiting} style={{ width: '100%' }}
                                ...
                                <Col span="12">
                                    <FormItem
                                        ...
                                        <ClerkSelectModalInput
                                            ...
                                            visible={measures.clerkTreeModalShow}
                                            onCancel={() => {
                                                dispatch({
                                                    type: 'measures/merge',
                                                    payload: {
                            ...
                            <Row>
                                <Col span="12">
                                    <FormItem
                                        ...
                                        >
                                        <InputNumber {...costProps} disabled={measures.submiting} style={{ width: '100%' }} />
                                    </FormItem>
                                </Col>
                                <Col span="12">
                                    <FormItem
